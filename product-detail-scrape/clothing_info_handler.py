...
def scrape0(event, context):
  data = fetch_url('clothing_url_0.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_0.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape1(event, context):
  data = fetch_url('clothing_url_1.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_1.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape2(event, context):
  data = fetch_url('clothing_url_2.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_2.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape3(event, context):
  data = fetch_url('clothing_url_3.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_3.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape4(event, context):
  data = fetch_url('clothing_url_4.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_4.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape5(event, context):
  data = fetch_url('clothing_url_5.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_5.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape6(event, context):
  data = fetch_url('clothing_url_6.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_6.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape7(event, context):
  data = fetch_url('clothing_url_7.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_7.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape8(event, context):
  data = fetch_url('clothing_url_8.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_8.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape9(event, context):
  data = fetch_url('clothing_url_9.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_9.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape10(event, context):
  data = fetch_url('clothing_url_10.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_10.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}

def scrape11(event, context):
  data = fetch_url('clothing_url_11.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_11.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
  
  return {'status': 'success'}


def scrape12(event, context):
  data = fetch_url('clothing_url_12.csv')
  info = get_info_all(data)
  file_name = f"clothing_info_12.csv"
  save_file_to_s3('ssense-mens-product-scrape', info, file_name)
